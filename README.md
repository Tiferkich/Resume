...
Мой путь в программировании начался с **системного программирования на C** в университете, где я прошел интенсивный курс по **Алгоритмам и структурам данных**. Этот опыт научил меня **управлению памятью на низком уровне** - каждый байт был под контролем, что заложило фундамент для понимания эффективности и производительности программ.
...
**Java и Enterprise разработка:** Параллельно изучал **Java**, где получил практический опыт в **Spring Boot**, **микросервисной архитектуре** и **JWT аутентификации** (см. проект Secure Password Manager в резюме).
