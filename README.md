...
![Старт игры](img/game2d_start.png)
*Начальный экран игры с главным меню*

![Игровой процесс](img/game2d_gameplay.png)
...
![Пример работы программы](img/assembler_c_comparison.png)
*Сравнение производительности C и Assembly кода*

![Результат обработки изображения](img/image_rotation_result.png)
...
✅ **Десктопные приложения** - Electron, кроссплатформенная разработка, Jetpack compose(для adroid приложений)
